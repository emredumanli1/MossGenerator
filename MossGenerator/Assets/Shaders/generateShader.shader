Shader "Custom/genShader"
{
    Properties
    {
        ...
        _GrowthOrigin ("Growth Origin (World)", Vector) = (0,0,0,0)
        _GrowthSpeed ("Growth Speed", Float) = 1.0
    }
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            {   
                ...
                float dist = distance(i.worldPos, _GrowthOrigin);
                float loopTime = fmod(_Time.y, 5.0);
                float growth = saturate((loopTime * _GrowthSpeed - dist) * 0.5);
